...
public class dice_home_page<animationListener> extends AppCompatActivity {


    int[] img = {R.drawable.dice1, R.drawable.diceb2, R.drawable.dice3, R.drawable.dice4, R.drawable.dice5, R.drawable.dice6};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_dice_home_page);
        binding();
...
//              anim1();
                ...
                MediaPlayer ring = MediaPlayer.create(dice_home_page.this, R.raw.shake_dice);
                ring.start();
...
//                media.start();
    ...
    private void animation() {
        final Animation anim1 = AnimationUtils.loadAnimation(dice_home_page.this, R.anim.shak);
        final Animation anim2 = AnimationUtils.loadAnimation(dice_home_page.this, R.anim.shak);
